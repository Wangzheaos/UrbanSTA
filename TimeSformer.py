...
from ST_transformer import DropPath
...
class Block(nn.Module):
    ...
    def forward(self, x, B, T):
        ...
        if self.attention_type in ['space_only', 'joint_space_time']:
            ...
            ## Temporal
            xt = x[:,1:,:]
            xt = rearrange(xt, 'b (l t) m -> (b l) t m',b=B,t=T)
            res_temporal = self.drop_path(self.temporal_attn(self.temporal_norm1(xt)))
            res_temporal = rearrange(res_temporal, '(b l) t m -> b (l t) m',b=B,t=T)
            ...
            xs = xt
            xs = rearrange(xs, 'b (l t) m -> (b t) l m',b=B,t=T)
            ...
            res_spatial = rearrange(res_spatial, '(b t) l m -> b (l t) m',b=B,t=T)
            res = res_spatial
            x = xt
