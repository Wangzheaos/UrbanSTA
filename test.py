...
import models_mae, models_mae2, models_mae2_2_poi, models_mae_poi
...
def get_args_parser():
    ...
    parser.add_argument('--resume', default='./Saved_model/data/TaxiBJ/P1/20/main_fixed-mae_vit_2-ps2/2022-06-24_12 44 43',
...
def main(args):
    ...
    f.write(
        "R_RMSE\t{:.2f}\tPOI_loss\t{:.2f}\tS_RMSE\t{:.2f}\tDS_RMSE\t{:.2f}\tT_RMSE\t{:.2f}\tDT_RMSE\t{:.2f}\tSF_RMSE\t{:.2f}\n\n".format(
            loss1, poi_loss, space_loss, d_space_loss, time_loss, d_time_loss, sf_loss))
    f.close()
