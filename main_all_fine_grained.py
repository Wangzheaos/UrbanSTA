...
import models_mae, models_mae_all, models_mae_all_fine_grained, models_mae2, models_mae2_2_poi

from engine_pretrain import train_one_epoch, train_one_epoch_complete, train_one_epoch_all
...
def get_args_parser():
    ...
    parser.add_argument('--f_model', default='mae_vit_13', type=str, metavar='MODEL',
    ...
    parser.add_argument('--fraction', type=int, default=5, help='fraction')

    parser.add_argument('--data_path', default='data/TaxiBJ/P1', type=str,
                        help='dataset path')
    parser.add_argument('--resume', default='./Saved_model/data/TaxiBJ/P1/20/complete-pre-mae_vit_1/2022-07-31_22 33 18',
                        help='resume from complete data model checkpoint')

    # parser.add_argument('--resume', default='', help='resume from complete data model checkpoint')
    ...
    #  in data=-1 no poi  './Saved_model/data/TaxiBJ/P1/20/complete-pre-mae_vit_1/2022-06-27_15 20 19'
    ...
    parser.add_argument('--beta', type=float, default=1, help='complete data Time loss')
...
def main(args):
    ...
    optimizer = torch.optim.AdamW([
        {'params': c_model.parameters(), 'lr': args.clr, 'betas': (0.9, 0.99)},
        {'params': f_model.parameters(), 'lr': args.flr, 'betas': (0.9, 0.99)}
    ])
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch_all(
            c_model, f_model, train_dataloader,
            optimizer, device, epoch, loss_scaler,
            log_writer=log_writer, mmn=mmn,
            args=args
        )
