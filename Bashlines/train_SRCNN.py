...
save_path = 'Saved_model/{}/{}/{}'.format('SRCNN', opt.dataset, opt.fraction)
...
# initial model
model = SRCNN(in_channels=opt.channels,
...
print_model_parm_nums(model, 'SRCNN')
