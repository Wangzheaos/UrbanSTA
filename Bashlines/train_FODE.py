...
parser.add_argument('--base_channels', type=int,
                    default=32, help='number of feature maps')
...
save_path = 'Saved_model/{}/{}/{}/{}'.format('FODE', opt.dataset, opt.fraction, opt.upscale_factor)
os.makedirs(save_path, exist_ok=True)
# writer = SummaryWriter('runs/{}/{}/{}'.format(opt.dataset, opt.fraction, 'FODE'))
...
for j, (flows_c, _, flows_f) in enumerate(test_dataloader):
    ...
    if j == 5:
        ...
        plt.savefig('../Figure/FODE.png', bbox_inches='tight')
        plt.show()
