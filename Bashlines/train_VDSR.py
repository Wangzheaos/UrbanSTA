...
save_path = './Saved_model/{}/{}/{}/{}'.format('VDSR', opt.dataset, opt.fraction, opt.upscale_factor)
os.makedirs(save_path, exist_ok=True)
# writer = SummaryWriter('runs/{}/{}/{}'.format(opt.dataset, opt.fraction, 'VDSR'))
...
# initial model
model = VDSR(in_channels=opt.channels,
...
for j, (flows_c, _, flows_f) in enumerate(test_dataloader):
    ...
    if j == 5:
        ...
        plt.savefig('../Figure/VDSR.png', bbox_inches='tight')
        plt.show()
