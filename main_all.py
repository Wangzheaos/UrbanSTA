...
import models_mae, models_mae_all, models_mae2, models_mae2_2_poi
...
def get_args_parser():
    ...
    parser.add_argument('--f_model', default='mae_vit_5', type=str, metavar='MODEL',
    ...
    parser.add_argument('--clr', type=float, default=1e-5, metavar='LR',
                        help='learning rate (absolute lr)')
    parser.add_argument('--flr', type=float, default=1e-5, metavar='LR',
