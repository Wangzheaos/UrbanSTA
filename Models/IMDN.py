...
from utils.data_process import print_model_parm_nums
...
class IMDN(nn.Module):
    def __init__(self, in_nc=1, nf=128, num_modules=6, out_nc=1, upscale=4):
...
if __name__ == '__main__':
    ...
    output1 = model(input)
    print(output1.shape)
    print_model_parm_nums(model, 'IMDN')